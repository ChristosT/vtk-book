...
6.5 Scanline rasterization proceeds along horizontal spans in graphics hardware (see ["Rasterization"](/VTKBook/03Chapter3.md#rasterization) in [Chapter 3](/VTKBook/03Chapter3)). Interpolation of color occurs along horizontal spans as well.
